...
window.APP_ENV = {
    ...
    INFO_POPUP_DESCRIPTION_1: 'OehlerOS Version: 1.0 (Stable). The LCHS Electro-Tech Inventory Management System is built on the OehlerOS platform, a custom platform designed to meet the specific needs that cookie cutter solutions cannot.',
